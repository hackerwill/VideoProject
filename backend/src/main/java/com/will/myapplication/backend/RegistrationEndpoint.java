 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.will.com", ownerName = "backend.myapplication.will.com", packagePath = ""))
